...
plt.plot(rl_stats_compute_curiosity.mean[1], rl_stats_compute_curiosity.mean[8], label="ppo RND", color='limegreen')
...
plt.plot(rl_stats_compute_entropy.mean[1], rl_stats_compute_entropy.mean[8], label="ppo RND+entropy", color='red')
...
plt.plot(rl_stats_compute_curiosity.mean[0], rl_stats_compute_curiosity.mean[8], label="ppo RND", color='limegreen')
...
plt.plot(rl_stats_compute_entropy.mean[0], rl_stats_compute_entropy.mean[8], label="ppo RND+entropy", color='red')
