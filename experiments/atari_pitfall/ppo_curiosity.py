...
envs = RLAgents.MultiEnvParallel("PitfallNoFrameskip-v4", RLAgents.WrapperMontezuma, config.actors)
#envs = RLAgents.MultiEnvSeq("PitfallNoFrameskip-v4", RLAgents.WrapperMontezuma, config.actors)
